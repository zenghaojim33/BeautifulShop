...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton setTitleColor:[UIColor colorWithRed:210/255.0f green:55/255.0f blue:55/255.0f alpha:1.0] forState:UIControlStateNormal];
        [closeButton.titleLabel setFont:[UIFont boldSystemFontOfSize:16.0]];
